...
export class GameReset {
   ...
   */
  showNewGameDialog() {
    const difficultyOptions = Object.values(this.difficulties)
      .map(
        difficulty => `
    ...
    setTimeout(() => {
      const difficultyElements = document.querySelectorAll('.difficulty-option');
      difficultyElements.forEach(option => {
        option.addEventListener('click', () => {
          difficultyElements.forEach(opt => opt.classList.remove('selected'));
